...
exports.openLocalSummaryView = openLocalSummaryView;
const vscode = __importStar(require("vscode"));
const apiClient_1 = require("./apiClient");
// Keep 1 panel instance max (so it feels modal, not “new tab spam”)
let localSummaryPanel = null;
async function openLocalSummaryView(context, installationId) {
    ...
    const nature = (summary.files || []).some((f) => /(\.test\.|\.spec\.|\/test\/)/i.test(f.path))
    ...
    localSummaryPanel = vscode.window.createWebviewPanel("devtracker.localSummaryPopup", " ", // important: minimal tab feel
...
//# sourceMappingURL=localSummaryView.js.map